...
# SSRL Utility Functions
from .ssrlbits.utils.ssrl_functions import host_on_ssrl_subnet
...
# Always load BL22 devices (disable subnet check for development)
# make_devices(clear=False, file="devices_ssrl_bl22.yml", device_manager=instrument)

if host_on_aps_subnet():
    make_devices(clear=False, file="devices_aps_only.yml", device_manager=instrument)

if host_on_ssrl_subnet():
    make_devices(clear=False, file="devices_ssrl_bl22.yml", device_manager=instrument)
